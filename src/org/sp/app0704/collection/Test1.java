 ...
 *  - 객체를 모아서 처리할때 유용한 기능을 지원하는 기술이며, 자바에서는 java.util
 *      패키지에서 지원함*/
...
public class Test1 extends JFrame implements ActionListener{
	...
	//배열 최소 생성시 그 크기가 고정된다. 또한 반드시 사용전에는 크기가 정해져 있어야 한다
	//JButton[] btArray;
	...
	public Test1() {
		...
		//주의) 버튼을 10개를 생성한 것이 아니라, 장차 버튼 10개가 들어갈 공간을 확보
		...
		bt_create.addActionListener(this);//버튼과 리스너 연결
		bt_bg.addActionListener(this); //버튼과 리스너 연결
